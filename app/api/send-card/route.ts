        ...
        if (cardSchemaJSON) {
            ...
            try {
                ...
                const payload: Record<string, unknown> = {
                    ...
                    description: null,
                    rarity: 'common',
                    is_online_playable: parsedCard.is_online_playable ?? false,
                    is_collectable_only: parsedCard.is_collectable_only ?? false,
                    is_creator_verified: false,
                    allow_trades: parsedCard.allow_trades ?? false,
                    is_draft: true,
                    is_published: false,
